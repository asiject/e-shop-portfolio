    ...
    <Box sx={tabYn ? styles.tabProduct : styles.productRight}>
      <Box sx={styles.productInfoArea}>
        <Box sx={tabYn ? styles.none : {}}>
          ...
          <Box sx={styles.productPrice}>{numberFormat(product.cost)}</Box>
        </Box>
      </Box>
      ...
      <Box sx={styles.totalInfoArea}>
        ...
        <Box sx={styles.productTotalValues}>
          <Box sx={styles.productStock}>총 {totalStock}개</Box>
          <Box sx={styles.productCost}>{numberFormat(totalCost)}</Box>
        </Box>
        <Box sx={styles.productBtnArea}>
          <Button variant="contained" sx={styles.productOrderBtn} size="large" onClick={handleBuy}>
            구매하기
          </Button>
          <Button variant="outlined" sx={styles.productCartBtn} size="large" onClick={handleCart}>
            장바구니
          </Button>
        </Box>
      </Box>
